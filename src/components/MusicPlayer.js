...
//-------------------------------------------------------------
  ...
  state = {
    ...
    {name:'Happy Song', author: 'HappyBoy', img: 'https://www.bensound.com/bensound-img/energy.jpg', audio:'https://www.bensound.com/bensound-music/bensound-energy.mp3', duration: '2:59'},  
    {name:'Gentle acoustic', author: 'Acoustic', img: 'https://www.bensound.com/bensound-img/sunny.jpg', audio:'https://www.bensound.com//bensound-music/bensound-sunny.mp3', duration: '2:20'},
      ...
      {name:'Happier Song!', author: 'HPB0Y', img: 'https://www.bensound.com/bensound-img/energy.jpg', audio:'https://www.bensound.com/bensound-music/bensound-energy.mp3', duration: '2:59'},
...
//-------------------------------------------------------------
  ...
  shuffle = () => {
const {musicList, index, pause } = this.state;
    this.setState({index: parseInt((musicList.length)*Math.random())
  });
  this.updatePlayer();
  if(pause){
    this.playerRef.play();
    ...
    return (
      <div className="card">
        <div className="current-song">
          ...
          <button onClick={this.shuffle} className="current-btn prev shuffle"><i className="fas fa-random"></i></button>
